...
### 2. IMPLEMENTAÇÃO DO HOOK `useConductors()`

```typescript
// Implementação profissional com React Query v5.56.2
const {
  conductors, // Todos os condutores
  activeConductors, // Apenas condutores ativos
...
- Substitui 20+ chamadas diretas `fetchActiveConductors`
...
| **AdminCalendarProvider.tsx**  | ⚠️ `fetchActiveConductors()` direto | PRECISA MODERNIZAR |
